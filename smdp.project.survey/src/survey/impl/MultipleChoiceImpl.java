 ...
 * <ul>
 *   <li>{@link survey.impl.MultipleChoiceImpl#getAnswers <em>Answers</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class MultipleChoiceImpl extends QuestionImpl implements MultipleChoice {
	...
	public EList<Answer> getAnswers() {
		if (answers == null) {
			answers = new EObjectContainmentEList<Answer>(Answer.class, this, SurveyPackage.MULTIPLE_CHOICE__ANSWERS);
		}
		return answers;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case SurveyPackage.MULTIPLE_CHOICE__ANSWERS:
