 ...
 * @generated
 */
public class AnswerImpl extends TextElementImpl implements Answer {
	/**
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == NamedElement.class) {
			switch (derivedFeatureID) {
				case SurveyPackage.ANSWER__NAME: return SurveyPackage.NAMED_ELEMENT__NAME;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == NamedElement.class) {
			switch (baseFeatureID) {
				case SurveyPackage.NAMED_ELEMENT__NAME: return SurveyPackage.ANSWER__NAME;
				default: return -1;
			}
		}
